...
model_path = os.path.join(".", "wights_raw.pickle")  # Assuming model is in the same directory
scaler_path = os.path.join(".", "scaler.pkl")  # Assuming scaler is in the same directory
